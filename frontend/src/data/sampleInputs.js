...
Summary
Junior data analyst with academic and project experience in Python, SQL, Excel, and dashboard reporting.
...
Education
Bachelor of Computer Science coursework with statistics, database, and software engineering projects.`;

export const sampleJobDescription = `We are looking for a Junior Data Analyst who can collect, clean, and analyze business data.
...
Experience with machine learning or NLP is considered an asset.`;
