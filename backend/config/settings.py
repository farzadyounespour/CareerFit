...
CAREERFIT_ENABLE_REMOTIVE = os.getenv("CAREERFIT_ENABLE_REMOTIVE", "True") == "True"
REMOTIVE_CACHE_SECONDS = int(os.getenv("REMOTIVE_CACHE_SECONDS", "43200"))
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "")
OPENAI_MODEL = os.getenv("OPENAI_MODEL", "gpt-5.4-mini")
CAREERFIT_ENABLE_LLM = os.getenv("CAREERFIT_ENABLE_LLM", "False") == "True"
CAREERFIT_LLM_PROVIDER = os.getenv("CAREERFIT_LLM_PROVIDER", "ollama").lower()
OPENAI_TIMEOUT_SECONDS = float(os.getenv("OPENAI_TIMEOUT_SECONDS", "20"))
OPENAI_MAX_OUTPUT_TOKENS = int(os.getenv("OPENAI_MAX_OUTPUT_TOKENS", "700"))
OPENAI_RESUME_MAX_OUTPUT_TOKENS = int(os.getenv("OPENAI_RESUME_MAX_OUTPUT_TOKENS", "3500"))
OPENAI_MAX_RETRIES = int(os.getenv("OPENAI_MAX_RETRIES", "1"))
OLLAMA_BASE_URL = os.getenv("OLLAMA_BASE_URL", "http://127.0.0.1:11434")
OLLAMA_MODEL = os.getenv("OLLAMA_MODEL", "gemma3:4b")
OLLAMA_EMBEDDING_MODEL = os.getenv("OLLAMA_EMBEDDING_MODEL", "")
OLLAMA_MAX_OUTPUT_TOKENS = int(os.getenv("OLLAMA_MAX_OUTPUT_TOKENS", "6000"))
OLLAMA_RESUME_MAX_OUTPUT_TOKENS = int(os.getenv("OLLAMA_RESUME_MAX_OUTPUT_TOKENS", "4500"))
OLLAMA_CONTEXT_TOKENS = int(os.getenv("OLLAMA_CONTEXT_TOKENS", "8192"))
CAREERFIT_ENABLE_EMBEDDINGS = os.getenv("CAREERFIT_ENABLE_EMBEDDINGS", "False") == "True"
CAREERFIT_EMBEDDING_CACHE_SECONDS = int(os.getenv("CAREERFIT_EMBEDDING_CACHE_SECONDS", "86400"))
OLLAMA_HEALTH_TIMEOUT_SECONDS = float(os.getenv("OLLAMA_HEALTH_TIMEOUT_SECONDS", "2"))
OLLAMA_TIMEOUT_SECONDS = float(os.getenv("OLLAMA_TIMEOUT_SECONDS", "120"))
CAREERFIT_TOKEN_TTL_HOURS = int(os.getenv("CAREERFIT_TOKEN_TTL_HOURS", "168"))
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "llm": os.getenv("CAREERFIT_LLM_RATE", "10/hour"),
    },
}
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "CareerFit <noreply@careerfit.local>")
